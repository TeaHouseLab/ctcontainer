function import
    ...
    if sudo cp -r $container $containername
        ...
        chroot_run $containername /bin/sh --login -c 'chown -R safety:safety /home/safety && chmod -R 755 /home/safety && passwd -u safety && echo "safety    ALL=(ALL:ALL) ALL" | tee -a /etc/sudoers' &>/dev/null
